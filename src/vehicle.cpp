...
vector<Vehicle> Vehicle::constant_speed_trajectory() {
    ...
    */
    ...
    vector<Vehicle> trajectory = {Vehicle(this->lane, this->s, this->velocity, this->acceleration, this->state), 
...
vector<Vehicle> Vehicle::keep_lane_trajectory(map<int, vector<Vehicle>> predictions) {
    ...
    */
    vector<Vehicle> trajectory = {Vehicle(lane, this->s, this->velocity, this->acceleration, state)};
...
vector<Vehicle> Vehicle::lane_change_trajectory(string state, map<int, vector<Vehicle>> predictions) {
    ...
    */
    ...
    trajectory.push_back(Vehicle(this->lane, this->s, this->velocity, this->acceleration, this->state));
